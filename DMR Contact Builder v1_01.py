...
def generate_csv_file(target_folder, update_status, radio_choice):
    ...
    if radio_choice == "Baofeng DM-32UV":
        ...
        final_filename = "DMR_CONTACTS_ANYTONE_FAMILY.csv"
    else:
        final_filename = "DMR_CONTACTS_TYT_RADIODDITY.csv"
...
app = ctk.CTk()
app.title("DMR Contact Builder v1.01")
...
# --- UI Layout ---
title = ctk.CTkLabel(app, text="DMR Contact List Generator by KR4DSO", font=("Segoe UI", 24, "bold"))
...
# Setup Dropdown Menu with Universal Families
